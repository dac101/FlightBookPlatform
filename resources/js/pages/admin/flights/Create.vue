...
defineOptions({
    layout: {
        breadcrumbs: [
            ...
            { title: 'Create', href: AdminFlightController.create.url() },
        ],
    },
});
</script>
...
<template>
    ...
    <div class="max-w-2xl p-6">
        <div class="mb-6 flex items-center justify-between">
            <h1 class="text-xl font-semibold">Create Flight</h1>
            <Link :href="AdminFlightController.index.url()">
                <Button variant="outline" size="sm">Back to Flights</Button>
            </Link>
        </div>

        <Form v-bind="AdminFlightController.store.form()" class="space-y-4" v-slot="{ errors, processing }">
            <div class="grid gap-4 sm:grid-cols-2">
                <div class="grid gap-1.5">
                    <Label for="flight_number">Flight Number</Label>
                    <Input id="flight_number" name="flight_number" required autofocus placeholder="e.g. 123" />
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <div class="grid gap-1.5">
                    ...
                    <Select name="airport_departure_id">
                        <SelectTrigger>
                ...
                <div class="grid gap-1.5">
                    ...
                    <Select name="airport_arrival_id">
                        <SelectTrigger>
            ...
            <div class="grid gap-1.5">
                ...
                <Input id="price" name="price" type="number" step="0.01" min="0" required placeholder="e.g. 299.99" class="max-w-48" />
                <InputError :message="errors.price" />
            </div>

            <Button type="submit" :disabled="processing">Create Flight</Button>
        </Form>
    </div>
</template>
